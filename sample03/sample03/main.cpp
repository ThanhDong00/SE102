...
void LoadResources()
{
	...
	// FIRE BULLET
	sprites->Add(10071, 569, 120, 577, 127, texMisc);
	sprites->Add(10072, 581, 119, 588, 127, texMisc);
	...
	ani->Add(10071);
	ani->Add(10072);
	animations->Add(ID_ANI_MARIO_FIRE_BULLET, ani);
	fireBall = new CFireBall(MARIO_START_X, MARIO_START_Y);
