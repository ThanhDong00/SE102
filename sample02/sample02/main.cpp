...
#pragma region myAdd
	LPTEXTURE texGBrick = textures->Get(ID_TEX_MISC);
	sprites->Add(30001, 300, 135, 315, 150, texGBrick);
	sprites->Add(30002, 318, 135, 333, 150, texGBrick);
	sprites->Add(30003, 336, 135, 351, 150, texGBrick);
	sprites->Add(30004, 354, 135, 369, 150, texGBrick);
	sprites->Add(30005, 372, 135, 387, 150, texGBrick);
	...
	gBrick = new CGBrick(120.0f, 100.0f);


	LPTEXTURE texGoomba = textures->Get(ID_TEX_ENEMY);

	sprites->Add(30006, 5, 14, 20, 29, texGoomba);
	sprites->Add(30007, 25, 14, 41, 29, texGoomba);

	/*sprites->Add(30008, 186, 154, 200, 181, texGoomba);
	sprites->Add(30009, 155, 154, 171, 181, texGoomba);*/
